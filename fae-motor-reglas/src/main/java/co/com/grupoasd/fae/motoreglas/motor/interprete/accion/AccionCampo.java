...
@Component
public class AccionCampo implements AccionTraducion {
	...
	public String getAccion(Accion accion) {
		...
		stringAccion.append("$" + accion.getObjOrigen().getNombre().toLowerCase() + ".");
		stringAccion.append(accion.getCampoOrigen() + ";");
