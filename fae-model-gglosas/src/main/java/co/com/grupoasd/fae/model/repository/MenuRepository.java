...
/**
 * Repositorio de la entidad Menu
...
public interface MenuRepository extends PagingAndSortingRepository<Menu, String>{
    Page<Menu> findByEstado(Boolean status, Pageable pageable);
    List<Menu> findByPadreMenu(String menuCodigoPadre);
}
