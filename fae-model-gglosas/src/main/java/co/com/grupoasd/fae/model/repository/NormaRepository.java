 ...
 */
public interface NormaRepository extends PagingAndSortingRepository<Norma, Long>{
    Page<Norma> findByEstado(Boolean status, Pageable pageable);
    List<Norma> findByTipoOrderByFechaInicioDesc(String tipo);
}
