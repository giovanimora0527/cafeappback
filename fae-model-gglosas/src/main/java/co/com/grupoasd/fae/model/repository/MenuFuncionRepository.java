/*
* Archivo: MenuFuncionRepository.java
* Fecha: 25/09/2018
 ...
 */
public interface MenuFuncionRepository extends PagingAndSortingRepository<MenuFuncion, MenuFuncionIdentity>{
    Page<MenuFuncion> findByEstado(Boolean status, Pageable pageable);
    List<MenuFuncion> findByMenuCodigo(Menu menuCodigo);
}
